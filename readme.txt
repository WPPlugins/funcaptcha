...
Yes. It works great with touch interfaces, and does not require any typing. All platforms used by a site’s customers are supported, including every kind of PC and Mac. In short, no user will be blocked.

= Is there audio accessibility? =
Yes.

= Does it work if Javascript is turned off? =
Yes. FunCaptcha works on all platforms, devices and form factors - all the way back to IE6 being fully supported.
